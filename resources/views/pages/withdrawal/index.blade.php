...
@section('content')
    <section class="container">
        <div class="card card-outline card-info">
            ...
            <div class="card-body" >
                <a href="{{url($bUrl.'/create')}}" class="btn bg-success text-white"><i class="mdi mdi-plus"></i> <i class="fa fa-plus-circle"></i> Add New Withdrawal</a>
                <br>
                <br>
                <div class="col-md-12 table-responsive">
                    <p>Name : {{$user->name}}</p>
                    <p>Current Balance : {{$user->balance}}</p>
                    <p>Transaction Type : Withdrawal</p>
